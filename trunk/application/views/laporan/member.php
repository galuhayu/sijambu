...
if ($content!=""){
	...
	foreach ($content as $member):
		...
		$this->table->add_row($member['jumpinjam'],$member['idmember'],$member['namamember'],$member['jeniskelamin'],$member['telepon'],$member['alamat'],$member['tempatlahir'],$member['tgllahir']);
	endforeach;
